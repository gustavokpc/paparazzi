...
extern uint32_t nn_cfc_control_mext_time_us;
extern const uint8_t nn_cfc_control_mext_mode;
...
extern float nn_cfc_control_measured_moment_nm[3];
extern float nn_cfc_control_modeled_moment_nm[3];
extern float nn_cfc_control_observer_filtered_rates[3];
