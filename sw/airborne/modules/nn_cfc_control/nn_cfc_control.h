...
extern int32_t nn_cfc_control_motor_pprz_cmd[4];
...
extern float nn_cfc_control_hover_rpm_training;
extern float nn_cfc_control_hover_rpm_gazebo;
extern float nn_cfc_control_rpm_delta_scale;
