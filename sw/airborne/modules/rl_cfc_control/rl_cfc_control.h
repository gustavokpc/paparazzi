...
extern uint32_t rl_cfc_control_mext_time_us;
extern const uint8_t rl_cfc_control_mext_mode;
...
extern float rl_cfc_control_external_moment_nm[3];
extern float rl_cfc_control_measured_moment_nm[3];
extern float rl_cfc_control_modeled_moment_nm[3];
extern float rl_cfc_control_observer_filtered_rates[3];
